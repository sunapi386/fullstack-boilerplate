...
export class CreateDatabase1587876385373 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      ...
      "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
      "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
      "plate_serial" character varying NOT NULL,
      "state" character varying NOT NULL,
      CONSTRAINT "PK_eebdaf4c97b73058fba01606616" PRIMARY KEY ("id"))`,
      undefined,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "complaint" ADD CONSTRAINT "FK_0722574160f24d00c5dada22994"
       FOREIGN KEY ("authorId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
      undefined,
    )
    await queryRunner.query(
      `ALTER TABLE "complaint" ADD CONSTRAINT "FK_65c49e19142bc007859ced462e3"
      FOREIGN KEY ("plateId") REFERENCES "plate"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
      undefined,
    )
  }
